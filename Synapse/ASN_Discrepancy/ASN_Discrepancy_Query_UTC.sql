...
-- Timezone: UTC only (no conversion)
-- Change @ReportDate to the date you want to investigate (UTC)
-- ============================================================
...
WITH pix AS (
    ...
    WHERE CAST(createddatetime AS DATE) = @ReportDate
      AND pxtxtp = '606'
      AND pxtxcd = '03'
...
d365 AS (
    ...
    WHERE T.dataareaid          = '1001'
      ...
      AND CAST(T.posteddatetime AS DATE) = @ReportDate
